...
//  WEEK 4 NOTE:
//  ------------
//  This header is carried forward UNCHANGED from Week 1 (the spec returns).
//  In Week 4 your strategy is the *consumer* end of a lock-free pipeline: a
//  decode thread turns a binary wire feed into csot::Tick records and hands
//  them across an SPSC ring buffer to a thread that drives exactly this
//  Strategy. See ../PIPELINE_SPEC.md for how the two fit together.
// ============================================================================
